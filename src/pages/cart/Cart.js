...
import { CartSection } from './CartStyle';
				...
				<div className="col-lg-5">
					{cartFoods.length >= 1 && (
						<div className="address-details">
							<h6>
								From <strong>Alaska London </strong>
							</h6>
							<p>Arrive in 15min - 1 Hours In London Areas </p>
							{isDelivery && (
								<p>
					...
					{cartFoods.length >= 1 && (
						<button
							...
							data-toggle="tooltip"
							data-placement="top"
							title={!isDelivery ? 'Please Fill delivery details to active place order' : ''}
						>
							Place Order
						</button>
					)}
